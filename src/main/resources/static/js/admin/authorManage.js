    ...
    oTable = $('#otable').DataTable(
        ...
        $.extend(true, {}, CONSTANT.DATA_TABLES.DEFAULT_OPTION, {
            ...
            "ajax": function (data, callback, settings) {
                //封装请求参数
                var param = authorManage.getQueryCondition(data);
                $.ajax({
                    type: "GET",
                    url: "/author/page",//TODO
                    cache: false, //禁用缓存
                    data: param, //传入已封装的参数
                    dataType: "json",
...
var authorManage = {
    ...
    getQueryCondition: function (data) {
        ...
        //组装查询参数
        param.fuzzySearch = authorManage.fuzzySearch;
        if (authorManage.fuzzySearch) {//模糊查询
...
$('#otable').on('click', 'a.op_freezeOrActive', function (e) {
    ...
    var nRow = $(this).parents('tr')[0];
    var id = oTable.row(nRow).id();
    var url = "/author/" + id + "/freezeOrActive";
